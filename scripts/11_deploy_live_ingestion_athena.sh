...
LIVE_TICKERS="${LIVE_TICKERS:-NVDA,TSLA,AAPL,GOOGL,MSFT,AMZN,JPM,BBVA,META,AMD,AVGO,INTC,NFLX,ORCL,BAC,GS,WMT,DIS}"
TASK_CPU="${TASK_CPU:-1024}"
TASK_MEMORY="${TASK_MEMORY:-4096}"
USE_BEDROCK_RELEVANCE="${USE_BEDROCK_RELEVANCE:-${USE_BEDROCK:-true}}"
...
aws cloudformation deploy \
  ...
  --parameter-overrides \
    ...
    UseBedrockRelevance="${USE_BEDROCK_RELEVANCE}" \
